...
exports.recupererUneConversation = async (req, res) => {
    res.send({ conversation: await Conversation.findOne({ "envoyeur": req.body.envoyeur , "recepteur": req.body.recepteur }).populate("envoyeur recepteur") })
}
